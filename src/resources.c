...
# define SECTION __attribute__ ((section (".gresource.gscp"), aligned (8)))
#else
# define SECTION
#endif

static const SECTION union { const guint8 data[1556]; const double alignment; void * const ptr;}  gscp_resource_data = { {
...
static GStaticResource static_resource = { gscp_resource_data.data, sizeof (gscp_resource_data.data), NULL, NULL, NULL };
extern GResource *gscp_get_resource (void);
GResource *gscp_get_resource (void)
{
